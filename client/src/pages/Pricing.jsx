...
function Pricing() {
  ...
  return (
    <div className='min-h-screen bg-[#0b0b0f] text-white overflow-hidden relative px-6 py-10'>
      ...
      <div className='relative z-10 max-w-6xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <PricingCard 
            ...
            features={[
              "50 Credits",
              "Valid for all note generations",
...
return(
  <motion.div
    ...
    className={`
      relative cursor-pointer rounded-2xl p-[1px]
      ${popular 
  ...
  >
    ...
    `}>
      ...
      {popular && (
        <span className='text-xs px-3 py-1 rounded-full bg-gradient-to-r from-purple-500 to-blue-500'>
          Most Popular
        </span>
      )}
      ...
      <div className='mt-5'>
        <p className='text-3xl font-bold'>{price}</p>
        <p className='text-sm text-purple-300'>{credits}</p>
      </div>
